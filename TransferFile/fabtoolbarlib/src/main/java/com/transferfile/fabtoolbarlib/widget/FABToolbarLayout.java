package com.transferfile.fabtoolbarlib.widget;
...
import com.transferfile.fabtoolbarlib.util.ExpandAnimationUtils;

import java.util.ArrayList;
import java.util.List;

import transfer.com.fabtoolbarlib.R;
        ...
        toolbarLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (toolbarLayout.getWidth() != 0 || toolbarLayout.getHeight() != 0) {
                    ...
                    LayoutParams fabParams = (LayoutParams) fab.getLayoutParams();
                    LayoutParams fabContainerParams = (LayoutParams) fabContainer.getLayoutParams();
