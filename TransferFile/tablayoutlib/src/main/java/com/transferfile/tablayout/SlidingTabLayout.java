...
import com.tablayoutlib.R;
import com.transferfile.tablayout.listener.OnTabSelectListener;
import com.transferfile.tablayout.utils.UnreadMsgUtils;
import com.transferfile.tablayout.widget.MsgView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    /** 关联ViewPager */
    public void setViewPager(ViewPager viewPager, ViewPager vp, FragmentActivity activity, Fragment mFragments) {
...
//        TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_tab_title);
        ImageView tv_tab_icon =(ImageView) tabView.findViewById(R.id.tv_tab_icon);
...
//        }
        ...
        {
            case "历史":
                tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.history1));
                break;
            case "图片":
                tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.image1));
                break;
            case "音频":
                tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.music1));
                break;
            case "视频":
                tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.video1));
                break;
            case "文档":
                tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.folder1));
                break;
            case "应用":
                tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.application1));
                break;
            default :
                break;
...
//            TextView tv_tab_title = (TextView) v.findViewById(R.id.tv_tab_title);
            ImageView tv_tab_icon=(ImageView) v.findViewById(R.id.tv_tab_icon);
            if(tv_tab_icon!=null)
            {
                if(i==0) {
                    if (i == mCurrentTab)
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.history));
                    else
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.history1));
                }
                if(i==1) {
                    if (i == mCurrentTab)
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.image));
                    else
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.image1));
                }
                if(i==2) {
                    if (i == mCurrentTab)
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.music));
                    else
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.music1));
                }
                if(i==3) {
                    if (i == mCurrentTab)
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.video));
                    else
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.video1));
                }
                if(i==4) {
                    if (i == mCurrentTab)
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.folder));
                    else
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.folder1));
                }
                if(i==5) {
                    if (i == mCurrentTab)
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.application));
                    else
                        tv_tab_icon.setImageDrawable(getResources().getDrawable(R.drawable.application1));
                }
...
//                tv_tab_icon.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
//                if (mTextAllCaps) {
...
//            TextView tab_title = (TextView) currentTabView.findViewById(R.id.tv_tab_title);
            ...
            float textWidth = mTextPaint.measureText("历史");
...
//                TextView next_tab_title = (TextView) nextTabView.findViewById(R.id.tv_tab_title);
                mTextPaint.setTextSize(mTextsize);
                float nextTextWidth = mTextPaint.measureText("历史");
